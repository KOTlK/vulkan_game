...
export union Quaternion {
    struct { float x, y, z, w; };
    float e[4];
};

export inline Quaternion quaternion_identity = {{0, 0, 0, 1}};
...
export inline Quaternion quaternion_make(const float x, const float y, const float z, const float w);
export inline Quaternion quaternion_angle_axis(const float angle, const Vector3& axis);
export inline Quaternion quaternion_angle_axis(const float angle, const float axis[3]);
export inline void       quaternion_to_angle_axis(const Quaternion& q, float& angle, Vector3& axis);
export inline Quaternion quaternion_euler(const Vector3& euler);
export inline Quaternion conjugate(const Quaternion& q);
export inline Quaternion inverse(const Quaternion& q);
export inline float      magnitude(const Quaternion& q);
export inline void       normalize(Quaternion& q);
export inline Quaternion normalized(const Quaternion& q);
export inline float      dot(const Quaternion& a, const Quaternion& b);
export inline Quaternion lerp(const Quaternion& a, const Quaternion& b, float t);
export inline Quaternion nlerp(const Quaternion& a, const Quaternion& b, float t);
export inline Quaternion slerp(const Quaternion& a, const Quaternion& b, const float t);
